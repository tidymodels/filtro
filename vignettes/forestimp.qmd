...
If users use the argument names from {ranger}, that’s fine. We have handled the necessary adjustments automatically. The following code chunk can be used to obtain the same fitted score: 
