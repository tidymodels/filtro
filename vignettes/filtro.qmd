...
- `show_best_desirability_prop()` shows best scores, based on proportion of predictors. 

- `show_best_desirability_num()` shows best scores, based on number of predictors.
