...
{filtro} consists of score class objects. Currently, the available score class objects include:
...
For example, a score class object consists of the following attributes:
...
ANOVA F-test filters handle cases when:
