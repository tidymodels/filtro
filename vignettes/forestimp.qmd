...
Predictor importance can be assessed using three different random forest models:
...
If users use the argument names from {ranger}, that’s fine. We’ve handled the necessary adjustments for them. Users can proceed with the following to obtain the same fitted score: 
